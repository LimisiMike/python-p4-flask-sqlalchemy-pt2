...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///app.db' #Points to an existing database
...
migrate = Migrate(app, db) #  instance configures the application and models for Flask-Migrate.
